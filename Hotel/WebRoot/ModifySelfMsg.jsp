...
<html>
  <head>
    ...
    <title>My JSP 'ModifySelfMsg.jsp' starting page</title>
  ...
  <body>
	...
	<br/>
  		...
  		<form action="/Hotel/servlet/ModifySelfMsg" method="post">
    	<table align="center" border="2" >
    		<tr><td colspan="2" align="center"><p class="text-primary">修改个人信息</p></td></tr>
    		<tr>
    			<td>用户名</td>
    			<td><input type="text" readOnly="true" name="NickName" value="${sessionScope.NickName} "/></td>
    		</tr>
    		<tr>
    			<td>密码</td>
    	...
    	<p class="text-danger" align="center">${Msg}</p>
